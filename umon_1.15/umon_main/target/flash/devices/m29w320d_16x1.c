 ...
 */
int
M29w320d_16x1_erase(struct flashinfo *fdev,int snum)
{
	ulong	add;
	int		ret;
 ...
 */
int
M29w320d_16x1_write(struct flashinfo *fdev,
...
/* EndM29w320d_16x1_write():
 * Function place holder to determine the end of the above function.
 */
void
EndM29w320d_16x1_write(void)
{}

/* M29w320d_16x1_ewrite():
 ...
 */
int
M29w320d_16x1_ewrite(struct flashinfo *fdev,
	uchar *dest,uchar *src,long bytecnt)
{
	volatile int	i;
	ulong	add;
...
/* EndM29w320d_16x1_ewrite():
 * Function place holder to determine the end of the above function.
 */
void
EndM29w320d_16x1_ewrite(void)
{}
 ...
 */
int
M29w320d_16x1_type(struct flashinfo *fdev)
{
	ushort	man, dev;
	ulong	id;
...
/* EndM29w320d_16x1_type():
 * Function place holder to determine the end of the above function.
 */
void
EndM29w320d_16x1_type(void)
{}
...
#ifdef FLASH_COPY_TO_RAM
	if (flashopload((ulong *)M29w320d_16x1_type,
		(ulong *)EndM29w320d_16x1_type,
		FlashTypeFbuf,sizeof(FlashTypeFbuf)) < 0)
		return(-1);
	
	if (flashopload((ulong *)M29w320d_16x1_erase,
		(ulong *)EndM29w320d_16x1_erase,
		FlashEraseFbuf,sizeof(FlashEraseFbuf)) < 0)
		return(-1);
	
	if (flashopload((ulong *)M29w320d_16x1_ewrite,
		(ulong *)EndM29w320d_16x1_ewrite,
		FlashEwriteFbuf,sizeof(FlashEwriteFbuf)) < 0)
		return(-1);
	
	if (flashopload((ulong *)M29w320d_16x1_write,
		(ulong *)EndM29w320d_16x1_write,
...
#else
	fbnk->fltype = M29w320d_16x1_type;
	fbnk->flerase = M29w320d_16x1_erase;
	fbnk->flwrite = M29w320d_16x1_write;
	fbnk->flewrite = M29w320d_16x1_ewrite;
#endif
