/* s29ws128n_16x2.c:
 * Device interface for the S29WS128N flash device configured for
...
/* S29ws128n_16x2_erase():
 * Based on the 'snum' value, erase the appropriate sector(s).
 * Return 0 if success, else -1.
 */
int
S29ws128n_16x2_erase(struct flashinfo *fdev,int snum)
{
    ftype   val;
    ulong   add;
    int ret, sector;
...
/* EndS29ws128n_16x2_write():
 * Function place holder to determine the end of the above function.
 */
void
EndS29ws128n_16x2_write(void)
{}

/* S29ws128n_16x2_ewrite():
 ...
 */
int
S29ws128n_16x2_ewrite(struct flashinfo *fdev,
	uchar *dest,uchar *src,long bytecnt)
{
    int i;
    ulong   add;
...
/* EndS29ws128n_16x2_ewrite():
 * Function place holder to determine the end of the above function.
 */
void
EndS29ws128n_16x2_ewrite(void)
{}
 ...
 */
int
S29ws128n_16x2_type(struct flashinfo *fdev)
{
    ushort  man, dev;
    ulong   id;
...
/* EndS29ws128n_16x2_type():
 * Function place holder to determine the end of the above function.
 */
void
EndS29ws128n_16x2_type(void)
{}
...
int SectorSizes[] = {
    ...
    0x40000, 0x40000, 0x40000, 0x40000, 0x40000, 0x40000, 0x40000, 
...
#ifdef FLASH_COPY_TO_RAM
	if (flashopload((ulong *)S29ws128n_16x2_type,
		(ulong *)EndS29ws128n_16x2_type,
		FlashTypeFbuf,sizeof(FlashTypeFbuf)) < 0)
		return(-1);

	if (flashopload((ulong *)S29ws128n_16x2_erase,
		(ulong *)EndS29ws128n_16x2_erase,
		FlashEraseFbuf,sizeof(FlashEraseFbuf)) < 0)
		return(-1);

	if (flashopload((ulong *)S29ws128n_16x2_ewrite,
		(ulong *)EndS29ws128n_16x2_ewrite,
		FlashEwriteFbuf,sizeof(FlashEwriteFbuf)) < 0)
		return(-1);

	if (flashopload((ulong *)S29ws128n_16x2_write,
		(ulong *)EndS29ws128n_16x2_write,
...
#else
	fbnk->fltype = S29ws128n_16x2_type;
	fbnk->flerase = S29ws128n_16x2_erase;
	fbnk->flwrite = S29ws128n_16x2_write;
	fbnk->flewrite = S29ws128n_16x2_ewrite;
#endif
