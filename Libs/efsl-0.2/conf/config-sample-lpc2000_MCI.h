...
#define __EFSL_CONFIG_H__
 ...
 /* This is for the LPC23x8 SD/MMC-Card interface (MCI) */
...
/* defines the interface for LPC23x8 SD/MMC interface */
/* possibly this will also work for the LPC24xx series */
	#define HW_ENDPOINT_LPC2000_MCI
