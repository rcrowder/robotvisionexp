...
SET OOCD_CFG_DBG=openocd_lpc2138_dbg_wiggler.cfg
SET OOCD_CFG_FLASH=openocd_lpc2138_flash_wiggler.cfg
goto LAB_END

:LAB_FTDI
rem For the "FTDI"-Interface
SET OOCD_EXE=%OOCD_INSTALLDIR%\openocd-ftd2xx.exe
SET OOCD_CFG_DBG=openocd_lpc2138_dbg_ftdi.cfg
SET OOCD_CFG_FLASH=openocd_lpc2138_flash_ftdi.cfg
