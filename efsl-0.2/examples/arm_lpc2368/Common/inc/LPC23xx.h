...
#define CLKSRCSEL_CLKSRC_MASK (3UL<<0)

// PLLSTAT - PLL Status register
#define PLLSTAT_MSEL_MASK   (0x7FFF<<0UL)
#define PLLSTAT_MSEL_OFFS   (0UL)
#define PLLSTAT_NSEL_MASK   (0xFF<<16UL)
#define PLLSTAT_NSEL_OFFS   (16UL)
...
#define PCONP_PCTIM0       (1UL<<1)
#define PCONP_PCTIM1       (1UL<<2)
#define PCONP_PCUAR0       (1UL<<3)
#define PCONP_PCUAR1       (1UL<<4)
#define PCONP_PCPWM1       (1UL<<6)
#define PCONP_PCI2C0       (1UL<<7)
#define PCONP_PCSPI        (1UL<<8)
#define PCONP_RTC          (1UL<<9)
#define PCONP_PCSSP1       (1UL<<10)
#define PCONP_PCEMC        (1UL<<11)
// Note: Clear the PDN bit in the AD0CR before clearing this bit, and set
// this bit before setting PDN:
#define PCONP_PCAD         (1UL<<12)
#define PCONP_PCAN1       (1UL<<13)
#define PCONP_PCAN2       (1UL<<14)
#define PCONP_PCI2C1      (1UL<<19)
#define PCONP_PCSSP0      (1UL<<21)
#define PCONP_TIM2        (1UL<<22)
#define PCONP_TIM3        (1UL<<23)
#define PCONP_PCUART2     (1UL<<24)
#define PCONP_PCUART3     (1UL<<25)
#define PCONP_PCI2C2      (1UL<<26)
#define PCONP_PCI2S       (1UL<<27)
#define PCONP_PCSDC       (1UL<<28)
#define PCONP_PCGPDMA     (1UL<<29)
#define PCONP_PCENET      (1UL<<30)
#define PCONP_PCUSB       (1UL<<31)

// PWMxTCR - PWM Timer Control Register
#define PWMnTCR_CounterEnable (1UL<<0)
#define PWMnTCR_CounterReset  (1UL<<1)
#define PWMnTCR_PWMEnable     (1UL<<3)

// PWMnCTRC - PWM Counter Control Register
#define PWMnCTRC_CounterTimerModeMask   (3UL<<0)
#define PWMnCTRC_TimerMode              (0UL<<0)
#define PWMnCTRC_CounterModeRaising     (1UL<<0)
#define PWMnCTRC_CounterModeFalling     (2UL<<0)
#define PWMnCTRC_CounterModeBoth        (3UL<<0)
#define PWMnCTRC_CounterInputSelectMask (3UL<<2)
#define PWMnCTRC_PCAP1_0                (0UL<<2)
#define PWMnCTRC_CAP1_1                 (1UL<<2)

// PWMnMCR - PWM Match Control Register
#define PWMnMCR_PWMMR0I  (1UL<<0)
#define PWMnMCR_PWMMR0R  (1UL<<1)
#define PWMnMCR_PWMMR0S  (1UL<<2)
#define PWMnMCR_PWMMR1I  (1UL<<3)
#define PWMnMCR_PWMMR1R  (1UL<<4)
#define PWMnMCR_PWMMR1S  (1UL<<5)
#define PWMnMCR_PWMMR2I  (1UL<<6)
#define PWMnMCR_PWMMR2R  (1UL<<7)
#define PWMnMCR_PWMMR2S  (1UL<<8)
#define PWMnMCR_PWMMR3I  (1UL<<9)
#define PWMnMCR_PWMMR3R  (1UL<<10)
#define PWMnMCR_PWMMR3S  (1UL<<11)
#define PWMnMCR_PWMMR4I  (1UL<<12)
#define PWMnMCR_PWMMR4R  (1UL<<13)
#define PWMnMCR_PWMMR4S  (1UL<<14)
#define PWMnMCR_PWMMR5I  (1UL<<15)
#define PWMnMCR_PWMMR5R  (1UL<<16)
#define PWMnMCR_PWMMR5S  (1UL<<17)
#define PWMnMCR_PWMMR6I  (1UL<<18)
#define PWMnMCR_PWMMR6R  (1UL<<19)
#define PWMnMCR_PWMMR6S  (1UL<<20)

// PWMnPCR - PWM Control Register
#define PWMnPCR_PWMSEL2  (1UL<<2)
#define PWMnPCR_PWMSEL3  (1UL<<3)
#define PWMnPCR_PWMSEL4  (1UL<<4)
#define PWMnPCR_PWMSEL5  (1UL<<5)
#define PWMnPCR_PWMSEL6  (1UL<<6)
#define PWMnPCR_PWMENA1  (1UL<<9)
#define PWMnPCR_PWMENA2  (1UL<<10)
#define PWMnPCR_PWMENA3  (1UL<<11)
#define PWMnPCR_PWMENA4  (1UL<<12)
#define PWMnPCR_PWMENA5  (1UL<<13)
#define PWMnPCR_PWMENA6  (1UL<<14)

// PWMnLER - PWM Latch Enable Register
#define PWMnLER_EnableMatch0Latch (1UL<<0)
#define PWMnLER_EnableMatch1Latch (1UL<<1)
#define PWMnLER_EnableMatch2Latch (1UL<<2)
#define PWMnLER_EnableMatch3Latch (1UL<<3)
#define PWMnLER_EnableMatch4Latch (1UL<<4)
#define PWMnLER_EnableMatch5Latch (1UL<<5)
#define PWMnLER_EnableMatch6Latch (1UL<<6)

// SnSPCR - SPI control register
#define SnSPCR_BitEnable   (1UL<<2)
#define SnSPCR_CPHA        (1UL<<3)
#define SnSPCR_CPOL        (1UL<<4)
#define SnSPCR_MSTR        (1UL<<5)
#define SnSPCR_LSBF        (1UL<<6)
#define SnSPCR_SPIE        (1UL<<7)
#define SnSPCR_BITS_MASK   (0xf<<8UL)
#define SnSPCR_BITS_OFFS   (8UL)
#define SnSPCR_BITS8       (8UL<<8)
#define SnSPCR_BITS9       (9UL<<8)
#define SnSPCR_BITS10      (10UL<<8)
#define SnSPCR_BITS11      (11UL<<8)
#define SnSPCR_BITS12      (12UL<<8)
#define SnSPCR_BITS13      (13UL<<8)
#define SnSPCR_BITS14      (14UL<<8)
#define SnSPCR_BITS15      (15UL<<8)
#define SnSPCR_BITS16      (0UL<<8)

// SSPnCR0 SSPn Control Register 0
#define SSPnCR0_DSS_MASK    (0xf<<0UL)
#define SSPnCR0_DSS_OFFS    (0UL)
#define SSPnCR0_BITS4       (3UL<<0)
#define SSPnCR0_BITS5       (4UL<<0)
#define SSPnCR0_BITS6       (5UL<<0)
#define SSPnCR0_BITS7       (6UL<<0)
#define SSPnCR0_BITS8       (7UL<<0)
#define SSPnCR0_BITS9       (8UL<<0)
#define SSPnCR0_BITS10      (9UL<<0)
#define SSPnCR0_BITS11      (10UL<<0)
#define SSPnCR0_BITS12      (11UL<<0)
#define SSPnCR0_BITS13      (12UL<<0)
#define SSPnCR0_BITS14      (13UL<<0)
#define SSPnCR0_BITS15      (14UL<<0)
#define SSPnCR0_BITS16      (16UL<<0)
#define SSPnCR0_FRF_MASK    (3UL<<4)
#define SSPnCR0_FRF_OFFS    (4UL)
#define SSPnCR0_SPI         (0UL<<4)
#define SSPnCR0_TI          (1UL<<4)
#define SSPnCR0_Microwire   (2UL<<4)
#define SSPnCR0_SP0         (1UL<<6)
#define SSPnCR0_SPH         (1UL<<7)
#define SSPnCR0_SCR_MASK    (0xf<<8)
#define SSPnCR0_SCR_OFFS    (8UL)

// SSPnCR0 SSPn Control Register 1
#define SSPnCR1_LBM         (1UL<<0)
#define SSPnCR1_SSE         (1UL<<1)
#define SSPnCR1_MS          (1UL<<2)
#define SSPnCR1_SOD         (1UL<<3)

//SSPnSR  SSPn Status Register
#define SSPnSR_TFE  (1UL<<0)
#define SSPnSR_TNF  (1UL<<1)
#define SSPnSR_RNE  (1UL<<2)
#define SSPnSR_RFF  (1UL<<3)
#define SSPnSR_BSY  (1UL<<4)
