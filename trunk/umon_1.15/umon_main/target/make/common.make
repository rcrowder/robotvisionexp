...
JZLIBDIR	= $(JFFS2DIR)/zlib_inflate
...
JZLIBSRC	= jz_infblock.c jz_infcodes.c jz_inffast.c jz_inflate.c \
			  jz_inftrees.c jz_infutil.c

GLIBSRC		= abs.c atoi.c crc16.c crc32.c ctypetbl.c div.c getopt.c \
			  inrange.c ldiv.c memccpy.c memchr.c memcmp.c memcpy.c \
			  memset.c pollconsole.c prascii.c printmem.c smemcpy.c \
			  smemset.c strcat.c strchr.c \
			  strcasecmp.c strcmp.c strcpy.c strlen.c strncat.c strncmp.c \
			  strncpy.c strpbrk.c strrchr.c strspn.c strstr.c strtok.c \
			  strtol.c strtolower.c strtoupper.c swap.c ticktock.c
