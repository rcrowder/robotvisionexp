...
/* 
	This is for the LPC2000 SD-Card SPI interface 
	by Martin Thomas and Mike Anton 
*/
...
*/
	...
	/* define to use LPC214x FAST-GPIO */
	// #define HW_ENDPOINT_LPC2000_FASTIO
	
	/* define to use LPC2000 SSP FIFO (not avail. for SPI0) */
	#define HW_ENDPOINT_LPC2000_SSPFIFO
	
	/* define to use LPC2000 automatic Chip-Select (not recommended) */
	// #define HW_ENDPOINT_LPC2000_SSPAUTOCS
