...
#define CSPI1_RXDATA	(*(volatile UINT *)(CSPI1_BASE_ADDR+0x00))	//  32bit cspi1 receive data reg
#define CSPI1_TXDATA	(*(volatile UINT *)(CSPI1_BASE_ADDR+0x04))	//  32bit cspi1 transmit data reg
#define CSPI1_CONTROL	(*(volatile UINT *)(CSPI1_BASE_ADDR+0x08))	//  32bit cspi1 control reg
#define CSPI1_INT	(*(volatile UINT *)(CSPI1_BASE_ADDR+0x0C))	//  32bit cspi1 interrupt stat/ctr reg
#define CSPI1_TEST	(*(volatile UINT *)(CSPI1_BASE_ADDR+0x10))	//  32bit cspi1 test reg
#define CSPI1_PERIOD	(*(volatile UINT *)(CSPI1_BASE_ADDR+0x14))	//  32bit cspi1 sample period ctrl reg
#define CSPI1_DMA	(*(volatile UINT *)(CSPI1_BASE_ADDR+0x18))	//  32bit cspi1 dma ctrl reg
#define CSPI1_RESET	(*(volatile UINT *)(CSPI1_BASE_ADDR+0x1C))	//  32bit cspi1 soft reset reg
...
#define CSPI2_RXDATA	(*(volatile UINT *)(CSPI2_BASE_ADDR+0x00))	//  32bit cspi2 receive data reg
#define CSPI2_TXDATA	(*(volatile UINT *)(CSPI2_BASE_ADDR+0x04))	//  32bit cspi2 transmit data reg
#define CSPI2_CONTROL	(*(volatile UINT *)(CSPI2_BASE_ADDR+0x08))	//  32bit cspi2 control reg
#define CSPI2_INT	(*(volatile UINT *)(CSPI2_BASE_ADDR+0x0C))	//  32bit cspi2 interrupt stat/ctr reg
#define CSPI2_TEST	(*(volatile UINT *)(CSPI2_BASE_ADDR+0x10))	//  32bit cspi2 test reg
#define CSPI2_PERIOD	(*(volatile UINT *)(CSPI2_BASE_ADDR+0x14))	//  32bit cspi2 sample period ctrl reg
#define CSPI2_DMA	(*(volatile UINT *)(CSPI2_BASE_ADDR+0x18))	//  32bit cspi2 dma ctrl reg
#define CSPI2_RESET	(*(volatile UINT *)(CSPI2_BASE_ADDR+0x1C))	//  32bit cspi2 soft reset reg
...
#define MAX_MPR3	(*(volatile UINT *)0x1003f300)	//  32bit max slv3 master priority reg
